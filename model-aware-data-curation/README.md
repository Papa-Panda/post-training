...
| 多样性覆盖 | 当前梯度空间还缺哪些方向？ | 梯度核谱熵 | Vendi, D4/SemDeDup, G-Vendi |
| 主动生成 | 如何补稀疏区域而非继续堆重复样本？ | 稀疏梯度簇 + rejection sampling | Prismatic Synthesis |
| 安全/持续学习 | 新能力如何不破坏旧能力？ | 梯度冲突与稳定-可塑性约束 | GrADS, OGS |
...
9. [`papers.md`](papers.md) — 论文索引、年份、状态与 claim 证据。
10. [`code/`](code/) + [`tests/`](tests/) — NumPy 最小 demo：target alignment、G-Vendi、稀疏簇选择、安全约束。
